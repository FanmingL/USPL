...
tuplenames = ('state', 'priv_state', 'last_state', 'last_priv_state', 'last_action', 'action', 'expert_action', 'next_state', 'next_priv_state',
              'reward', 'logp', 'mask', 'start', 'done', 'reward_input', 'timeout', 'target_embedding', 'embedding_noise', 'target_logstd', 'target_flag', 'next_target_logstd')
