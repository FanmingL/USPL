...
class WebViewer:
    def __init__(self, output_dir, maximum_camera_num, host: str = "127.0.0.1", port: int = 5555) -> None:
        """
    ...
    def overlay_matplotlib_image(img_rgb, x_offset=10, y_offset=10,
                                 ...
                                 ego_yaw=0, tgt_x=0, tgt_y=0, xlim=None, ylim=None, fig_lock=None):
        """
    ...
    def render_all(self,
        ...
        def modify_image_i(env_id):
            ...
            if 'target_logstd' in kwargs and env_id in self._focused_camera_ids[:5]:
                ...
                self.overlay_matplotlib_image(image, x_offset=700, y_offset=200,
                                              mean_x=mean_x,
                                              mean_y=mean_y,
                                              std_x=std_x,
                                              std_y=std_y,
                                              ...
                                              ego_yaw=float(self._env.yaw[env_id]),
                                              tgt_x=-float(goal[0]),
                                              tgt_y=-float(goal[1]),
                                              xlim=xlim,
                                              ylim=ylim,
