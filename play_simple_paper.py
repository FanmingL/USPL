...
from legged_gym.utils.webviewer_local_save_paper import WebViewer
...
def play(log_name, task_name, alg_name):
    ...
    remote_env_additional_configs = {
        ...
        'env_num_rows': 8 if write_video or not web else 8,
        'env_num_cols': 8 if write_video or not web else 8,
